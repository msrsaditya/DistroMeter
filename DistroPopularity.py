...
st.markdown("""
    ...
    <div class="title-container">
        ...
        <div class="last-updated">Last Updated ⚡ Dec 14th, 2025</div>
    </div>
""", unsafe_allow_html=True)

distributions = ["chromeos", "archlinux", "Ubuntu", "Proxmox", "linuxmint", "Fedora", "Kalilinux", "debian", "tails", "pop_os", "ManjaroLinux", "truenas", "redhat", "SteamOS", "NixOS", "openSUSE", "Gentoo", "batocera", "Bazzite", "EndeavourOS", "cachyos", "OpenMediaVault", "elementaryos", "voidlinux", "Qubes", "Kubuntu", "CentOS", "AsahiLinux", "NobaraProject", "zorinos", "SolusProject", "Whonix", "RockyLinux", "MXLinux", "linuxfromscratch", "GarudaLinux", "AlmaLinux", "kdeneon", "Lubuntu", "3CX", "xubuntu", "recalbox", "AlpineLinux", "slackware", "tuxedocomputers", "ParrotOS", "artixlinux", "libreELEC", "archcraft", "UbuntuMATE", "GUIX", "deepin", "vyos", "Lakka", "dietpi", "puppylinux", "Freedombox", "BlackArchOfficial", "bedrocklinux", "CrunchBang", "holoiso", "crunchbangplusplus", "vanillaos", "ArcoLinux", "antergos", "raspbian", "devuan", "PikaOS", "kisslinux", "BunsenLabs", "antiXLinux", "trisquel", "windowmaker", "bodhilinux", "chimeralinux", "PeppermintOS", "UbuntuBudgie", "Mageia", "RedStarOS", "Parabola", "Armbian", "yunohost", "LinuxLite", "FerenOS", "ipfire", "tinycorelinux", "OfficialArchLabsLinux", "BlendOS", "Q4OS", "UbuntuUnity", "instantos", "ubuntucinnamon", "OpenMandriva", "rhinolinux", "rebornos", "OracleLinux", "TurnkeyLinux", "ultramarine", "regata_os", "geckolinux", "MaboxLinux", "t2sde", "sabayon", "Kicksecure", "pureos", "RockStor", "BackBox", "kinoite", "archbang", "cruxlinux", "NethServer", "endlessos", "SpiralLinux", "exherbo", "obarun", "SparkyLinuxOrg", "siduction", "SliTaz", "kodachilinux", "Crystal_Linux", "zentyal", "solydxk", "AVLinux", "AltLinux", "venomlinux", "UbuntuKylin", "scientificlinux", "EliveLinux", "RedCore", "kaos", "risiOS", "rlxos_dev", "openKylin", "Linspire"]

popularity = [575378, 341515, 269914, 176489, 167327, 156602, 129920, 125715, 123122, 92919, 76905, 74879, 51577, 48927, 48410, 43571, 36646, 30322, 29648, 29622, 29283, 26461, 24484, 19159, 18186, 18032, 16934, 16202, 15463, 15406, 11771, 11121, 10434, 9737, 9431, 8105, 7806, 7362, 7324, 7319, 7105, 6443, 6416, 6339, 6335, 5130, 4782, 4772, 4620, 4450, 4371, 3884, 3350, 3276, 2878, 2155, 2136, 2089, 2081, 2048, 1961, 1691, 1654, 1635, 1415, 1379, 1263, 1017, 995, 985, 904, 899, 850, 805, 789, 756, 727, 672, 662, 620, 587, 575, 548, 532, 503, 454, 399, 379, 378, 372, 359, 357, 327, 313, 312, 283, 276, 265, 260, 204, 204, 204, 202, 199, 199, 194, 180, 177, 171, 168, 135, 128, 126, 125, 122, 100, 96, 85, 80, 78, 72, 71, 68, 67, 67, 63, 59, 58, 56, 44, 44, 41, 35, 18]
